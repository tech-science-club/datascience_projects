...
for index, row in data.iterrows():
    ...
    with pd.ExcelWriter(f'{start_year}.xlsx', engine='xlsxwriter') as writer:
...
plt.tight_layout()
ax.legend(items, title="Transport", loc="upper left", bbox_to_anchor=(1, 0, 0.5, 1), fontsize='small', shadow=True)
